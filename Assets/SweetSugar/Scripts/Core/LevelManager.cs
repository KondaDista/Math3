...
//game state enum
    ...
    public class LevelManager : MonoBehaviour
    {
        ...
        public void EnableMap(bool enable)
        {
            ...
            if (enable)
            {
                mainCamera.GetComponent<MapCamera>()
                    .SetPosition(new Vector2(0, mainCamera.transform.position.y));
            ...
            if (!enable)
                mainCamera.transform.position = new Vector3(0, 0, -10) - (Vector3)orientationGameCameraHandle.offsetFieldPosition;
...
// #endif
        ...
        void MouseDownRight(Vector2 pos)
        {
            ...
            if (hit != null)
            {
                ...
                mainCamera.GetComponent<ItemChangerTest>().ShowMenuItems(item);
...
//            DestroyItems(true);
        ...
        private bool collectIngredients;
